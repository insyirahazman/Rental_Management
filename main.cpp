...
void ViewAllPayment(Payment payments[], int size)
{
    ...
    if (size == 0) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            cout << "Amount Paid (RM): " << payments[i].PaymentAmount << endl;
...
void TenantPaymentMenu()
{
    ...
    do{
        ...
        cout << "Enter your choice from 0-2: ";
        cin >> paymentoption;
        switch (paymentoption)
        {
            case 0:
                cout << "Return to Tenant Menu";
                break;
                ...
                do
                {
                    ...
                    switch (OwnerChoice)
                    {
                        ...
                        case 2:
                        {
                            ...
                            cout << "Owner updated successfully!" << endl;
                            cout << "Press Enter to continue...";
                            cin.ignore();
                            cin.get();
                            break;
                        ...
                        case 5:
                        {
                            ...
                            int id = propertyManager.AddProperty(ownerId, address, details, deposit, rent, status);
                            if (id != -1)
                            {
                                cout << "Property added successfully! Property ID: " << id << endl;
                            }
                    ...
                    switch (tenantChoice)
                    {
                        ...
                        case 1:
                        {
                            ...
                            while (manager.DoesTenantExist(TenantID))
                            {
                                ...
                                cout << "Details will be stored in the next available index." << endl;
...
int main(){
    ...
    do
    {
        ...
        case 2:
            ...
            break;
        case 3:
            cout<<"Thank you for using our system. See you again!!"<<endl;
            break;
        default:
            cout<<"Invalid choice. Choose between 1 to 3"<<endl;
            cout << "Press Enter to continue...";
            cin.ignore();
            cin.get();
            break;
